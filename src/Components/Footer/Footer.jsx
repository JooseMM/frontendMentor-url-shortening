...
import facebook from "../../Media/images/icon-facebook.svg";
import instagram from "../../Media/images/icon-instagram.svg";
import pinterest from "../../Media/images/icon-pinterest.svg";
import twitter from "../../Media/images/icon-twitter.svg";
  ...
  return (
    <div className="footer-container">
      ...
      <div className="links-footer-container">
        <ul className="footer-list" aria-label="Features">
          <li>
        ...
        <ul className="footer-list" aria-label="Resources">
          <li>
            <a href="#Blog">Blog</a>
          </li>
          <li>
        ...
        <ul className="footer-list" aria-label="Company">
          <li>
